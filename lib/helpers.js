...
module.exports = {
    ...
    mapURL: function(location) {
        var openstreetmap = 'http://www.openstreetmap.org/';
        return new Handlebars.SafeString(openstreetmap + '?mlat=' + Handlebars.escapeExpression(location.latitude || '0') + '&mlon=' + Handlebars.escapeExpression(location.longitude || '0') + '#map=' + Handlebars.escapeExpression(location.zoom || '9') + '/' + Handlebars.escapeExpression(location.latitude || '0') + '/' + Handlebars.escapeExpression(location.longitude || '0'));
    },
